...
func HandlerWithOptions(si ServerInterface, options StdHTTPServerOptions) http.Handler {
	...
	m.HandleFunc("GET "+options.BaseURL+"/certs", wrapper.GetCerts)
	m.HandleFunc("POST "+options.BaseURL+"/certs", wrapper.PostCerts)
	m.HandleFunc("GET "+options.BaseURL+"/verify", wrapper.Verify)
